...
public class Person {
	...
	/*
	 * public Person(String name, String surname, long jMBG, int token, String
	 * password,String map) { super(); this.name = name; this.surname = surname;
	 * JMBG = jMBG; this.token = token; this.password = password;
	 * this.map=stringToMap(map); }
	 * 
	 * public Person(String name, String surname,int token, long jMBG, String
	 * password,String time) { super(); this.name = name; this.surname = surname;
	 * JMBG = jMBG; this.token = token; this.password = password; this.time=time; }
	 */
	...
	public String toString() {
		return "Person [name=" + name + ", surname=" + surname + ", password=" + password + ", token=" + token
				+ ", JMBG=" + JMBG + ", map=" + mapToString(map) + ", status=" + status + ", time=" + time
				+ ", isBlocked=" + isBlocked + "]";
	}
