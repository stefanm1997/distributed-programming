...
public class RegisterServiceLocator extends org.apache.axis.client.Service implements org.unibl.etf.mdp.soap.services.RegisterService {
    ...
    private java.lang.String Register_address = "http://localhost:8080/MDP-COVID19-TokenServer/services/Register";
    ...
    public org.unibl.etf.mdp.soap.services.Register getRegister(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.unibl.etf.mdp.soap.services.RegisterSoapBindingStub _stub = new org.unibl.etf.mdp.soap.services.RegisterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.unibl.etf.mdp.soap.services.Register.class.isAssignableFrom(serviceEndpointInterface)) {
                org.unibl.etf.mdp.soap.services.RegisterSoapBindingStub _stub = new org.unibl.etf.mdp.soap.services.RegisterSoapBindingStub(new java.net.URL(Register_address), this);
                _stub.setPortName(getRegisterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.soap.mdp.etf.unibl.org", "RegisterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.soap.mdp.etf.unibl.org", "Register"));
        }
